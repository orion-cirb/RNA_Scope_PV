...
public class CellOutliner {
  ...
  public boolean buildMaskOutput;
  public boolean processAllFrames;
  public boolean processAllSlices;
  ...
  public ImagePlus maskImp = new ImagePlus();

  /** {@inheritDoc} */
  public boolean setup(String arg, ImagePlus imp) {
  ...
  public void run(ImageProcessor inputProcessor) {
    ...
    if (buildMaskOutput) {
      ...
      maskImp = WindowManager.getImage(title);
      if (maskImp == null) {
